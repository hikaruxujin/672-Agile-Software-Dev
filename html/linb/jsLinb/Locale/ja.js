(linb.Locale.ja||(linb.Locale.ja={})).inline={
    ok:'O K',
    cancel:'キャンセル',
    today:'今日',
    now:'今',
...
linb.Locale.ja.date={
    ...
    MDHN:function(n,a,b,c,d){return linb.getRes('date.MONTHS.'+a) + "月" + b+ '日 ' + c + ":" + d},
    HNS:function(n,a,b,c){return a+":"+b+":"+c},
    HNSMS:function(n,a,b,c,d){return a+":"+b+":"+c + ' ' +d},
    YM:function(n,a,b){return a + '年' + linb.getRes('date.MONTHS.'+b)+'月'},
