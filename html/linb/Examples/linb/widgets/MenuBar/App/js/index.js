Class('App', 'linb.Com',{
    Instance:{
        ...
        iniComponents:function(){
            ...
            host.pane16.append((new linb.UI.MenuBar)
        ...
        _menubar2_onshowsubmenu:function (profile, popProfile, item, src) {
            ...
            if(!obj){
                switch(item.id){
                    ...
                    break;
                    case 'customized pop':
                        obj=linb.create({key:'linb.UI.Panel',properties:{dock:'none',width:200,heihgt:300},children:[[{
                            key:'linb.UI.TreeBar',
                            properties:{
        ...
        _menubar2_onmenuselected:function (profile, subprf, item, src) {
            linb.message((item.id||'')+ ' ' + (item.value||''));
        }
    }
});