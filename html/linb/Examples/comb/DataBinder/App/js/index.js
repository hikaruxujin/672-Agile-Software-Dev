Class('App', 'linb.Com',{
    Instance:{
        ...
        _ctl_updatevalue_onclick : function (profile, e, src, value) {
            ...
            linb.message("Values are updated and reflected onto UI.");
        },
        _ctl_checkvalue_onclick : function (profile, e, src, value) {
            linb.message(this.databinder_1.checkValid()?"All inputs is valid!":"Invalid input exists!");
        },
        _ctl_getdirtied_onclick : function (profile, e, src, value) {
            linb.message("Dirtied values : "+_.stringify(this.databinder_1.getDirtied(true)));
        },
        _ctl_updatedatafromui_onclick : function (profile, e, src, value) {
            ...
            linb.message("Values in DataBinder : "+_.stringify(this.databinder_1.getData()));
        },
        ...
        _ctl_setdata_onclick : function (profile, e, src, value) {
            this.databinder_1.setData({Name:"Jack Lee", Gender:"male", Memo:"The author of LINB framework"});
            this.databinder_1.updateDataToUI();
            linb.message("Values in DataBinder : "+_.stringify(this.databinder_1.getData()));
        },
        _ctl_read_onclick : function (profile, e, src, value) {
            this.databinder_1.read(function(data){
                linb.message("onSuccess",data);
            }, function(msg){
                linb.message("onFail",msg);               
            }, function(){
                linb.message("onStart");                
            }, function(){
                linb.message("onEnd");                
            }, "busy", null, null, 
            // you can adjust data here                       
