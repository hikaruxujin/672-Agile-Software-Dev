...
var CodeMirror = (function(){
  ...
  setDefaults(CodeMirrorConfig, {
    ...
    path: "",
    parserfile: [],
    basefiles: ["js/util.js", "js/stringstream.js", "js/select.js", "js/undo.js", "js/editor.js", "js/tokenize.js"],
    iframeClass: null,
    passDelay: 200,
    passTime: 50,
    lineNumberDelay: 200,
  ...
  function addLineNumberDiv(container) {
    ...
    // linb
    nums.className = "CodeMirror-line-numbers-bg";
    scroller.className = "CodeMirror-line-numbers";
    nums.appendChild(scroller);
    scroller.innerHTML = "<div>1<span></span></div>";
    return nums;
  }
  ...
  function frameHTML(options) {
    ...
    var html = ['<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html style="padding:0;margin:0;"><head>'];
  ...
  CodeMirror.prototype = {
    init: function() {
      ...
      if(internetExplorer)
        this.win.document.execCommand('RespectVisibilityInDesign', true, null);
    },
    ...
    activateLineNumbers: function() {
      ...
      function ensureEnoughLineNumbers(fill) {
        ...
        var arr=[],
            from=scroller.childNodes.length+1,
            temp = document.createElement('div'),
            fragment=document.createDocumentFragment();
        for(var i=from; i<=lastNumber+1; i++){
          arr.push("<div>"+(fill ? (i+"<span></span>"): "\u00a0")+"</div>");
        }
