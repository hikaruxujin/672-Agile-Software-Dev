...
Class("linb.UI.AdvResizer","linb.UI.Resizer",{
    Instance:{
        ...
        cssRegion:function(){
            ...
            if(target){
                var purge=linb.$cache.domPurgeData;
                    ...
                    var t,fun=function(p,e,src){
                        ...
                        if(o.onRegionClick && false!==b.onRegionClick(o,e))
                            if(t._nodes.length>1){
                                var tid=linb.getNodeData(src,'_tid');
                                if(key && key.shiftKey){
                                    t._nodes.removeValue(tid);
                                    b.resetTarget(t);
                                }else
                                    b.focus(tid);
                            }
        ...
        resetTarget:function(target,flag){
            ...
            if(target && !target.isEmpty()){
                ...
                ids=null;
            if(flag!==false)
                profile.boxing().onItemsSelected(profile, ids, profile.$linbid);
    ...
    Static:{
        ...
        _onMousedown:function(profile, e, src, ddparas){
            ...
            if(ck && (ck.ctrlKey || (linb.browser.kde&&ck.key==' '))){
